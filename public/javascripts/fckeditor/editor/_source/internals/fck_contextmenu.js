          ...
          if (bIsCell) {
            ...
            if (FCKBrowserInfo.IsGecko)
              oItem.AddItem(
                ...
                FCKLang.MergeCells,
                60,
                FCKCommands.GetCommand("TableMergeCells").GetState() ==
              ...
              oItem.AddItem(
                ...
                FCKLang.MergeRight,
                60,
                FCKCommands.GetCommand("TableMergeRight").GetState() ==
                  FCK_TRISTATE_DISABLED
              );
              oItem.AddItem(
                "TableMergeDown",
                FCKLang.MergeDown,
                60,
                FCKCommands.GetCommand("TableMergeDown").GetState() ==
                  FCK_TRISTATE_DISABLED
              );
            }
            oItem.AddItem(
            ...
            oItem.AddItem(
              ...
              61,
              FCKCommands.GetCommand("TableVerticalSplitCell").GetState() ==
                FCK_TRISTATE_DISABLED
            );
            oItem.AddSeparator();
            oItem.AddItem(
              ...
              57,
              FCKCommands.GetCommand("TableCellProp").GetState() ==
                FCK_TRISTATE_DISABLED
            );
      ...
      return {
        AddItems: function (menu, tag, tagName) {
          ...
          if (
            ...
            menu.AddSeparator();
            if (bInsideLink) menu.AddItem("Link", FCKLang.EditLink, 34);
