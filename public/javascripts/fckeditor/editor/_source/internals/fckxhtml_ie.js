  ...
  for (var n = 0; n < aAttributes.length; n++) {
    ...
    if (oAttribute.specified) {
      ...
      // attribute. It returns "null" for the nodeValue.
        ...
        sAttValue = htmlNode.style.cssText.replace(
      ...
      } else if (sAttName.indexOf("on") == 0) sAttValue = oAttribute.nodeValue;
      else if (nodeName == "body" && sAttName == "contenteditable") continue;
