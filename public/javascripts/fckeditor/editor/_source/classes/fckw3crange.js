...
FCKW3CRange.prototype = {
  ...
  selectNodeContents: function (refNode) {
    ...
    this.setEnd(
      refNode,
      refNode.nodeType == 3 ? refNode.data.length : refNode.childNodes.length
    );
  },
  ...
  _ExecContentsAction: function (action, docFrag) {
    ...
    if (startNode.nodeType == 3) {
      ...
      if (startOffset == 0) {
        ...
        removeStartNode = true;
      } else startNode = startNode.childNodes[startOffset].previousSibling;
    }
    ...
    for (var j = i; j < startParents.length; j++) {
      ...
      while (currentNode) {
        ...
        if (currentNode == endParents[j] || currentNode == endNode) break;
    ...
    for (var k = i; k < endParents.length; k++) {
      ...
      if (
        ...
        while (currentNode) {
          ...
          if (currentNode == startParents[k] || currentNode == startNode) break;
