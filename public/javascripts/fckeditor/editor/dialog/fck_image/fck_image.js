...
function UpdatePreview() {
  ...
  if (GetE("txtUrl").value.length == 0) eImgPreviewLink.style.display = "none";
  else {
  ...
  if (oImageOriginal && bLockRatio) {
    ...
    if (dimension == "Width")
      value =
        value == 0
          ? 0
          : Math.round(oImageOriginal.height * (value / oImageOriginal.width));
    else
      value =
        value == 0
          ? 0
          : Math.round(oImageOriginal.width * (value / oImageOriginal.height));
