...
var FCKLang = {
  ...
  FontFormats:
    "Normale;Formattato;Indirizzo;Titolo 1;Titolo 2;Titolo 3;Titolo 4;Titolo 5;Titolo 6;Paragrafo (DIV)",
  ...
  NotCompatiblePaste:
    "Questa funzione è disponibile solo per Internet Explorer 5.5 o superiore. Desideri incollare il testo senza pulirlo?",
  ...
  NoActiveX:
    "Le impostazioni di sicurezza del tuo browser potrebbero limitare alcune funzionalità dell'editor. Devi abilitare l'opzione \"Esegui controlli e plug-in ActiveX\". Potresti avere errori e notare funzionalità mancanti.",
  BrowseServerBlocked:
    "Non è possibile aprire la finestra di espolorazione risorse. Verifica che tutti i blocca popup siano bloccati.",
  DialogBlocked:
    "Non è possibile aprire la finestra di dialogo. Verifica che tutti i blocca popup siano bloccati.",
  ...
  DlnLnkMsgInvPopName:
    "Il nome del popup deve iniziare con una lettera, e non può contenere spazi",
  ...
  PasteErrorCut:
    "Le impostazioni di sicurezza del browser non permettono di tagliare automaticamente il testo. Usa la tastiera (Ctrl+X).",
  PasteErrorCopy:
    "Le impostazioni di sicurezza del browser non permettono di copiare automaticamente il testo. Usa la tastiera (Ctrl+C).",

  PasteAsText: "Incolla come testo semplice",
  PasteFromWord: "Incolla da Word",

  DlgPasteMsg2:
    "Incolla il testo all'interno dell'area sottostante usando la scorciatoia di tastiere (<STRONG>Ctrl+V</STRONG>) e premi <STRONG>OK</STRONG>.",
  DlgPasteSec:
  ...
  DlgSpellNoChanges:
    "Controllo ortografico completato: nessuna parola cambiata",
  ...
  DlgTemplatesSelMsg:
    "Seleziona il modello da aprire nell'editor<br />(il contenuto attuale verrà eliminato):",
