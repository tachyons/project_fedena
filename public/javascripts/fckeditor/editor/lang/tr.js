...
var FCKLang = {
  ...
  FontFormats:
    "Normal;Biçimli;Adres;Başlık 1;Başlık 2;Başlık 3;Başlık 4;Başlık 5;Başlık 6;Paragraf (DIV)",

  // Alerts and Messages
  ProcessingXHTML: "XHTML işleniyor. Lütfen bekleyin...",
  Done: "Bitti",
  PasteWordConfirm:
    "Yapıştırdığınız yazı Word'den gelmişe benziyor. Yapıştırmadan önce gereksiz eklentileri silmek ister misiniz?",
  NotCompatiblePaste:
    "Bu komut Internet Explorer 5.5 ve ileriki sürümleri için mevcuttur. Temizlenmeden yapıştırılmasını ister misiniz ?",
  ...
  NoActiveX:
    'Kullandığınız tarayıcının güvenlik ayarları bazı özelliklerin kullanılmasını engelliyor. Bu özelliklerin çalışması için "Run ActiveX controls and plug-ins (Activex ve eklentileri çalıştır)" seçeneğinin aktif yapılması gerekiyor. Kullanılamayan eklentiler ve hatalar konusunda daha fazla bilgi sahibi olun.',
  BrowseServerBlocked:
    'Kaynak tarayıcısı açılamadı. Tüm "popup blocker" programlarının devre dışı olduğundan emin olun. (Yahoo toolbar, Msn toolbar, Google toolbar gibi)',
  DialogBlocked:
    'Diyalog açmak mümkün olmadı. Tüm "Popup Blocker" programlarının devre dışı olduğundan emin olun.',
  ...
  DlnLnkMsgInvPopName:
    "Açılır pencere adı abecesel bir karakterle başlamalı ve boşluk içermemelidir",
  ...
  PasteErrorCut:
    "Gezgin yazılımınızın güvenlik ayarları düzenleyicinin otomatik kesme işlemine izin vermiyor. İşlem için (Ctrl+X) tuşlarını kullanın.",
  PasteErrorCopy:
    "Gezgin yazılımınızın güvenlik ayarları düzenleyicinin otomatik kopyalama işlemine izin vermiyor. İşlem için (Ctrl+C) tuşlarını kullanın.",

  PasteAsText: "Düz Metin Olarak Yapıştır",
  PasteFromWord: "Word'den yapıştır",

  DlgPasteMsg2:
    "Lütfen aşağıdaki kutunun içine yapıştırın. (<STRONG>Ctrl+V</STRONG>) ve <STRONG>Tamam</STRONG> butonunu tıklayın.",
  DlgPasteSec:
