...
var FCKLang = {
  ...
  NotCompatiblePaste:
    "이 명령은 인터넷익스플로러 5.5 버전 이상에서만 작동합니다. 포멧을 삭제하지 않고 붙여넣기 하시겠습니까?",
  UnknownToolbarItem: '알수없는 툴바입니다. : "%1"',
  UnknownCommand: '알수없는 기능입니다. : "%1"',
  NotImplemented: "기능이 실행되지 않았습니다.",
  UnknownToolbarSet: '툴바 설정이 없습니다. : "%1"',
  NoActiveX:
    '브러우저의 보안 설정으로 인해 몇몇 기능의 작동에 장애가 있을 수 있습니다. "액티브-액스 기능과 플러그 인" 옵션을 허용하여 주시지 않으면 오류가 발생할 수 있습니다.',
  BrowseServerBlocked:
    "브러우저 요소가 열리지 않습니다. 팝업차단 설정이 꺼져있는지 확인하여 주십시오.",
  DialogBlocked:
    "윈도우 대화창을 열 수 없습니다. 팝업차단 설정이 꺼져있는지 확인하여 주십시오.",
  ...
  PasteErrorCut:
    "브라우저의 보안설정때문에 잘라내기 기능을 실행할 수 없습니다. 키보드 명령을 사용하십시요. (Ctrl+X).",
  PasteErrorCopy:
    "브라우저의 보안설정때문에 복사하기 기능을 실행할 수 없습니다. 키보드 명령을 사용하십시요.  (Ctrl+C).",

  PasteAsText: "텍스트로 붙여넣기",
  PasteFromWord: "MS Word 형식에서 붙여넣기",

  DlgPasteMsg2:
    "키보드의 (<STRONG>Ctrl+V</STRONG>) 를 이용해서 상자안에 붙여넣고 <STRONG>OK</STRONG> 를 누르세요.",
  DlgPasteSec:
