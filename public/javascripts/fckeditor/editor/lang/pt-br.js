...
var FCKLang = {
  ...
  FontFormats:
    "Normal;Formatado;Endereço;Título 1;Título 2;Título 3;Título 4;Título 5;Título 6",
  ...
  NotCompatiblePaste:
    "Este comando está disponível para o navegador Internet Explorer 5.5 ou superior. Você gostaria de colar sem remover a formatação?",
  ...
  NoActiveX:
    'As configurações de segurança do seu browser podem limitar algumas características do editor. Você precisa habilitar a opção "Executar controles e plug-ins ActiveX". Você pode experimentar erros e alertas de características faltantes.',
  BrowseServerBlocked:
    "Os recursos do browser não puderam ser abertos. Tenha certeza que todos os bloqueadores de popup estão desabilitados.",
  DialogBlocked:
    "Não foi possível abrir a janela de diálogo. Tenha certeza que todos os bloqueadores de popup estão desabilitados.",
  ...
  DlnLnkMsgInvPopName:
    "O nome da janela popup deve começar com uma letra ou sublinhado (_) e não pode conter espaços",
  ...
  PasteErrorCut:
    "As configurações de segurança do seu navegador não permitem que o editor execute operações de recortar automaticamente. Por favor, utilize o teclado para recortar (Ctrl+X).",
  PasteErrorCopy:
    "As configurações de segurança do seu navegador não permitem que o editor execute operações de copiar automaticamente. Por favor, utilize o teclado para copiar (Ctrl+C).",

  PasteAsText: "Colar como Texto sem Formatação",
  PasteFromWord: "Colar do Word",

  DlgPasteMsg2:
    "Transfira o link usado no box usando o teclado com (<STRONG>Ctrl+V</STRONG>) e <STRONG>OK</STRONG>.",
  DlgPasteSec:
    "As configurações de segurança do seu navegador não permitem que o editor acesse os dados da área de transferência diretamente. Por favor cole o conteúdo novamente nesta janela.",
