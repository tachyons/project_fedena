...
var FCKLang = {
  ...
  NotCompatiblePaste:
    "Cette commande nécessite Internet Explorer version 5.5 et plus. Souhaitez-vous coller sans nettoyage?",
  ...
  DlgPasteMsg2:
    "Veuillez coller dans la zone ci-dessous en utilisant le clavier (<STRONG>Ctrl+V</STRONG>) et appuyer sur <STRONG>OK</STRONG>.",
  DlgPasteSec:
  ...
  DlgSpellNoMispell:
    "Vérification d'orthographe terminée: pas d'erreur trouvée",
  DlgSpellNoChanges:
  ...
  DlgTemplatesSelMsg:
    "Sélectionner le modèle à ouvrir dans l'éditeur<br>(le contenu actuel sera remplacé):",
  DlgTemplatesLoading:
