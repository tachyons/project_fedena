...
var FCKLang = {
  ...
  FontFormats:
    "Normaali;Muotoiltu;Osoite;Otsikko 1;Otsikko 2;Otsikko 3;Otsikko 4;Otsikko 5;Otsikko 6",

  // Alerts and Messages
  ProcessingXHTML: "Prosessoidaan XHTML:ää. Odota hetki...",
  Done: "Valmis",
  PasteWordConfirm:
    "Teksti, jonka haluat liittää, näyttää olevan kopioitu Wordista. Haluatko puhdistaa sen ennen liittämistä?",
  NotCompatiblePaste:
    "Tämä komento toimii vain Internet Explorer 5.5:ssa tai uudemmassa. Haluatko liittää ilman puhdistusta?",
  ...
  NoActiveX:
    'Selaimesi turvallisuusasetukset voivat rajoittaa joitain editorin ominaisuuksia. Sinun pitää ottaa käyttöön asetuksista "Suorita ActiveX komponentit ja -plugin-laajennukset". Saatat kohdata virheitä ja huomata puuttuvia ominaisuuksia.',
  BrowseServerBlocked:
    "Resurssiselainta ei voitu avata. Varmista, että ponnahdusikkunoiden estäjät eivät ole päällä.",
  DialogBlocked:
    "Apuikkunaa ei voitu avaata. Varmista, että ponnahdusikkunoiden estäjät eivät ole päällä.",
  ...
  DlnLnkMsgInvPopName:
    "Popup-ikkunan nimi pitää alkaa aakkosella ja ei saa sisältää välejä",
