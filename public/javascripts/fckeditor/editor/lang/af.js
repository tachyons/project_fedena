...
var FCKLang = {
  ...
  FontFormats:
    "Normaal;Geformateerd;Adres;Opskrif 1;Opskrif 2;Opskrif 3;Opskrif 4;Opskrif 5;Opskrif 6;Normaal (DIV)",

  // Alerts and Messages
  ProcessingXHTML: "XHTML word verarbeit. U geduld asseblief...",
  Done: "Kompleet",
  PasteWordConfirm:
    "Die informasie wat U probeer byvoeg is warskynlik van Word. Wil U dit reinig voor die byvoeging?",
  NotCompatiblePaste:
    "Die instruksie is beskikbaar vir Internet Explorer weergawe 5.5 of hor. Wil U dir byvoeg sonder reiniging?",
  ...
  NoActiveX:
    'U browser sekuriteit instellings kan die funksies van die editor behinder. U moet die opsie "Run ActiveX controls and plug-ins" aktiveer. U ondervinding mag problematies geskiet of sekere funksionaliteit mag verhinder word.',
  BrowseServerBlocked:
    'Die vorraad venster word geblok! Verseker asseblief dat U die "popup blocker" instelling verander.',
  DialogBlocked:
    'Die dialoog venster vir verdere informasie word geblok. De-aktiveer asseblief die "popup blocker" instellings wat dit behinder.',
  ...
  DlnLnkMsgInvPopName:
    "Die popup naam moet begin met alphabetiese karakters sonder spasies.",
  ...
  PasteErrorCut:
    "U browser se sekuriteit instelling behinder die uitsny aksie. Gebruik asseblief die sleutel kombenasie(Ctrl+X).",
  PasteErrorCopy:
    "U browser se sekuriteit instelling behinder die kopieerings aksie. Gebruik asseblief die sleutel kombenasie(Ctrl+C).",

  PasteAsText: "Voeg slegs karakters by",
  PasteFromWord: "Byvoeging uit Word",

  DlgPasteMsg2:
    "Voeg asseblief die inhoud in die gegewe box by met sleutel kombenasie(<STRONG>Ctrl+V</STRONG>) en druk <STRONG>OK</STRONG>.",
  DlgPasteSec:
  ...
  DlgTemplatesSelMsg:
    "Kies die template om te gebruik in die editor<br>(Inhoud word vervang!):",
