...
var FCKLang = {
  ...
  FontFormats:
    "Normal;Formatiert;Addresse;Überschrift 1;Überschrift 2;Überschrift 3;Überschrift 4;Überschrift 5;Überschrift 6;Normal (DIV)",
  ...
  NotCompatiblePaste:
    "Diese Funktion steht nur im Internet Explorer ab Version 5.5 zur Verfügung. Möchten Sie den Text unbereinigt einfügen?",
  ...
  NoActiveX:
    'Die Sicherheitseinstellungen Ihres Browsers beschränken evtl. einige Funktionen des Editors. Aktivieren Sie die Option "ActiveX-Steuerelemente und Plugins ausführen" in den Sicherheitseinstellungen, um diese Funktionen nutzen zu können',
  BrowseServerBlocked:
    "Ein Auswahlfenster konnte nicht geöffnet werden. Stellen Sie sicher, das alle Popup-Blocker ausgeschaltet sind.",
  DialogBlocked:
    "Das Dialog-Fenster konnte nicht geöffnet werden. Stellen Sie sicher, das alle Popup-Blocker ausgeschaltet sind.",
  ...
  DlnLnkMsgInvPopName:
    "Der Name des Popups muss mit einem Buchstaben beginnen und darf keine Leerzeichen enthalten",
  ...
  DlgSpellNoMispell:
    "Rechtschreibprüfung abgeschlossen - keine Fehler gefunden",
