...
var FCKLang = {
  ...
  NotCompatiblePaste:
    "Ova naredba je dostupna samo u Internet Exploreru 5.5 ili novijem. Želite li nastaviti bez čišćenja?",
  ...
  NoActiveX:
    'Vaše postavke pretraživača mogle bi ograničiti neke od mogućnosti editora. Morate uključiti opciju "Run ActiveX controls and plug-ins" u postavkama. Ukoliko to ne učinite, moguće su razliite greške tijekom rada.',
  BrowseServerBlocked:
    "Pretraivač nije moguće otvoriti. Provjerite da li je uključeno blokiranje pop-up prozora.",
  DialogBlocked:
    "Nije moguće otvoriti novi prozor. Provjerite da li je uključeno blokiranje pop-up prozora.",
  ...
  DlnLnkMsgInvPopName:
    "Ime popup prozora mora početi sa slovom i ne smije sadržavati razmake",
  ...
  PasteErrorCut:
    "Sigurnosne postavke Vašeg pretraživača ne dozvoljavaju operacije automatskog izrezivanja. Molimo koristite kraticu na tipkovnici (Ctrl+X).",
  PasteErrorCopy:
    "Sigurnosne postavke Vašeg pretraživača ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tipkovnici (Ctrl+C).",

  PasteAsText: "Zalijepi kao čisti tekst",
  PasteFromWord: "Zalijepi iz Worda",

  DlgPasteMsg2:
    "Molimo zaljepite unutar doljnjeg okvira koristeći tipkovnicu (<STRONG>Ctrl+V</STRONG>) i kliknite <STRONG>OK</STRONG>.",
  DlgPasteSec:
