...
var FCKLang = {
  ...
  Done: "Hecho",
  PasteWordConfirm:
    "El texto que desea parece provenir de Word. Desea depurarlo antes de pegarlo?",
  NotCompatiblePaste:
    "Este comando está disponible sólo para Internet Explorer version 5.5 or superior. Desea pegar sin depurar?",
  ...
  NoActiveX:
    'La configuración de las opciones de seguridad de su navegador puede estar limitando algunas características del editor. Por favor active la opción "Ejecutar controles y complementos de ActiveX ", de lo contrario puede experimentar errores o ausencia de funcionalidades.',
  BrowseServerBlocked:
    "La ventana de visualización del servidor no pudo ser abierta. Verifique que su navegador no esté bloqueando las ventanas emergentes (pop up).",
  DialogBlocked:
    "No se ha podido abrir la ventana de diálogo. Verifique que su navegador no esté bloqueando las ventanas emergentes (pop up).",
  ...
  DlnLnkMsgInvPopName:
    "El nombre debe empezar con un caracter alfanumérico y no debe contener espacios",
  ...
  PasteErrorCut:
    "La configuración de seguridad de este navegador no permite la ejecución automática de operaciones de cortado. Por favor use el teclado (Ctrl+X).",
  PasteErrorCopy:
    "La configuración de seguridad de este navegador no permite la ejecución automática de operaciones de copiado. Por favor use el teclado (Ctrl+C).",

  PasteAsText: "Pegar como Texto Plano",
  PasteFromWord: "Pegar desde Word",

  DlgPasteMsg2:
    "Por favor pegue dentro del cuadro utilizando el teclado (<STRONG>Ctrl+V</STRONG>); luego presione <STRONG>OK</STRONG>.",
  DlgPasteSec:
    "Debido a la configuración de seguridad de su navegador, el editor no tiene acceso al portapapeles. Es necesario que lo pegue de nuevo en esta ventana.",
  ...
  IeSpellDownload:
    "Módulo de Control de Ortografía no instalado. ¿Desea descargarlo ahora?",
