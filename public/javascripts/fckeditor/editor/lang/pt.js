...
var FCKLang = {
  ...
  Done: "Concluído",
  PasteWordConfirm:
    "O texto que deseja parece ter sido copiado do Word. Deseja limpar a formatação antes de colar?",
  NotCompatiblePaste:
    "Este comando só está disponível para Internet Explorer versão 5.5 ou superior. Deseja colar sem limpar a formatação?",
  ...
  NoActiveX:
    'As definições de segurança do navegador podem limitar algumas potencalidades do editr. Deve activar a opção "Executar controlos e extensões ActiveX". Pode ocorrer erros ou verificar que faltam potencialidades.',
  BrowseServerBlocked:
    "Não foi possível abrir o navegador de recursos. Certifique-se que todos os bloqueadores de popup estão desactivados.",
  DialogBlocked:
    "Não foi possível abrir a janela de diálogo. Certifique-se que todos os bloqueadores de popup estão desactivados.",
  ...
  PasteErrorCut:
    "A configuração de segurança do navegador não permite a execução automática de operações de cortar. Por favor use o teclado (Ctrl+X).",
  PasteErrorCopy:
    "A configuração de segurança do navegador não permite a execução automática de operações de copiar. Por favor use o teclado (Ctrl+C).",

  PasteAsText: "Colar como Texto Simples",
  PasteFromWord: "Colar do Word",

  DlgPasteMsg2:
    "Por favor, cole dentro da seguinte caixa usando o teclado (<STRONG>Ctrl+V</STRONG>) e prima <STRONG>OK</STRONG>.",
  DlgPasteSec:
  ...
  DlgSpellManyChanges:
    "Verificação ortográfica completa: %1 palavras alteradas",
