...
var FCKLang = {
  ...
  NotCompatiblePaste:
    "Lệnh này chỉ được hỗ trợ từ trình duyệt Internet Explorer phiên bản 5.5 hoặc mới hơn. Bạn có muốn dán nguyên mẫu?",
  ...
  NoActiveX:
    'Các thiết lập bảo mật của trình duyệt có thể giới hạn một số chức năng của trình biên tập. Bạn phải bật tùy chọn "Run ActiveX controls and plug-ins". Bạn có thể gặp một số lỗi và thấy thiếu đi một số chức năng.',
  BrowseServerBlocked:
    "Không thể mở được bộ duyệt tài nguyên. Hãy đảm bảo chức năng chặn popup đã bị vô hiệu hóa.",
  DialogBlocked:
    "Không thể mở được cửa sổ hộp thoại. Hãy đảm bảo chức năng chặn popup đã bị vô hiệu hóa.",
  ...
  DlnLnkMsgInvPopName:
    "Tên của cửa sổ Popup phải bắt đầu bằng một ký tự và không được chứa khoảng trắng",
  ...
  PasteErrorCut:
    "Các thiết lập bảo mật của trình duyệt không cho phép trình biên tập tự động thực thi lệnh cắt. Hãy sử dụng bàn phím cho lệnh này (Ctrl+X).",
  PasteErrorCopy:
    "Các thiết lập bảo mật của trình duyệt không cho phép trình biên tập tự động thực thi lệnh sao chép. Hãy sử dụng bàn phím cho lệnh này (Ctrl+C).",

  PasteAsText: "Dán theo định dạng văn bản thuần",
  PasteFromWord: "Dán với định dạng Word",

  DlgPasteMsg2:
    "Hãy dán nội dung vào trong khung bên dưới, sử dụng tổ hợp phím (<STRONG>Ctrl+V</STRONG>) và nhấn vào nút <STRONG>Đồng ý</STRONG>.",
  DlgPasteSec:
  ...
  DlgSpellNoChanges:
    "Hoàn tất kiểm tra chính tả: Không có từ nào được thay đổi",
  ...
  DlgTemplatesLoading:
    "Đang nạp Danh sách Mẫu dựng sẵn. Vui lòng đợi trong giây lát...",
