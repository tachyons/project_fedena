    ...
    processHTML: function (h) {
      ...
      if (s.keep_values) {
        ...
        if (/<script|noscript|style/i.test(h)) {
          ...
          h = h.replace(/<script([^>]+|)>([\s\S]*?)<\/script>/gi, function (
            v,
            attribs,
            text
          ) {
          ...
          // Wrap style elements
          h = h.replace(/<style([^>]+|)>([\s\S]*?)<\/style>/gi, function (
            v,
            attribs,
            text
          ) {
          ...
          h = h.replace(/<noscript([^>]+|)>([\s\S]*?)<\/noscript>/g, function (
            v,
            attribs,
            text
          ) {
        ...
        function processTags(html) {
          return html.replace(tagRegExp, function (
            match,
            elm_name,
            attrs,
            end
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.AddOnManager", {
    ...
    load: function (n, u, cb, s) {
      ...
      if (!t.lookup[n]) tinymce.ScriptLoader.add(u, cb, s);
    },
  });
    ...
    _addEvents: function () {
      ...
      each(lo, function (v, k) {
        switch (k) {
          case "contextmenu":
            ...
            } else dom.bind(t.getBody(), k, eventHandler);
            break;
      ...
      if (tinymce.isWebKit) {
        t.onClick.add(function (ed, e) {
          ...
          if (
            e.nodeName == "IMG" ||
            (e.nodeName == "A" && dom.hasClass(e, "mceItemAnchor"))
          ) {
