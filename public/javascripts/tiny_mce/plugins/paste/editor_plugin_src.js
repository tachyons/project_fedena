  ...
  tinymce.create("tinymce.plugins.PastePlugin", {
    init: function (ed, url) {
      ...
      function grabContent(e) {
        ...
        if (ed.pasteAsPlainText && (e.clipboardData || dom.doc.dataTransfer)) {
          ...
          process(
            {
              content: (e.clipboardData || dom.doc.dataTransfer).getData(
                "Text"
              ),
            },
            true
      ...
      if (o.wordContent) {
        ...
        if (
          ...
          each(dom.select("*", o.node), function (el) {
            ...
            if (styleProps && npc > 0) dom.setStyles(el, newStyle);
    ...
    _convertLists: function (pl, o) {
      ...
      each(dom.select("p", o.node), function (p) {
        ...
        if (/^__MCE_ITEM__\s*\w+\.\s*\u00a0{2,}/.test(val)) type = "ol";
    ...
    _insertBlockContent: function (ed, dom, content) {
      ...
      while ((elm = dom.get(markerId))) dom.remove(elm);
      ...
      if (typeof h === "string" && h.length > 0) {
        if (!entities)
          entities = (
            ...
            ed.serializer.settings.entities
          ).split(",");
          ...
          [
            ...
            function (e, s) {
              if (s.charAt(0) === "#") {
                ...
                return (e = inArray(entities, s)) > 0
                  ? String.fromCharCode(entities[e - 1])
                  : " ";
              }
            },
          ],
        ...
        ed.execCommand(
          "mceInsertRawHTML",
          false,
          h + '<span id="_plain_text_marker">&nbsp;</span>'
        );
