  ...
  function TableGrid(table, dom, selection) {
    ...
    function cloneCell(cell) {
          ...
          if (node.nodeType == 3) {
            each(
              ...
              function (node) {
                ...
                if (!formatNode) formatNode = curNode = node;
                else if (curNode) curNode.appendChild(node);
      ...
      if (formatNode) {
        ...
        if (!tinymce.isIE) cell.innerHTML = '<br _mce_bogus="1" />';
      }
    ...
    function insertRow(before) {
      ...
      if (newRow.hasChildNodes()) {
        if (!before) dom.insertAfter(newRow, rowElm);
        else rowElm.parentNode.insertBefore(newRow, rowElm);
      }
    }
      ...
      function deleteRow(tr) {
        ...
        each(grid[pos.y], function (cell) {
          ...
          if (cell != lastCell) {
            ...
            if (rowSpan <= 1) dom.remove(cell);
            else cell.rowSpan = rowSpan - 1;
    ...
    function pasteRows(rows, before) {
      ...
      each(rows, function (row) {
        ...
        // Add before/after
        if (before) targetRow.parentNode.insertBefore(row, targetRow);
        else dom.insertAfter(row, targetRow);
      });
    }
    ...
    function setEndCell(cell) {
      ...
      if (startPos && endPos) {
        ...
        dom.removeClass(
          dom.select("td.mceSelected,th.mceSelected"),
          "mceSelected"
        );
  ...
  tinymce.create("tinymce.plugins.TablePlugin", {
    init: function (ed, url) {
      ...
      function cleanup() {
        ...
        ed.dom.removeClass(
          ed.dom.select("td.mceSelected,th.mceSelected"),
          "mceSelected"
        );
      }
      ...
      ed.onInit.add(function (ed) {
        ...
        if (ed && ed.plugins.contextmenu) {
          ed.plugins.contextmenu.onContextMenu.add(function (th, m, e) {
            ...
            if (
              ed.dom.getParent(e, "td") ||
              ed.dom.getParent(e, "th") ||
              ...
              if (
                el.nodeName == "IMG" &&
                el.className.indexOf("mceItem") == -1
              ) {
                m.add({
            ...
            } else m.add({ title: "table.desc", icon: "table", cmd: "mceInsertTable" });
          });
        }
        ...
        if (!tinymce.isIE) {
          function fixTableCaretPos() {
            ...
            for (
              ...
              last && last.nodeType == 3 && !last.nodeValue.length;
              ...
              winMan.open(
                {
                  ...
                  width:
                    240 +
                    parseInt(ed.getLang("table.merge_cells_delta_width", 0)),
                  height:
                    110 +
                    parseInt(ed.getLang("table.merge_cells_delta_height", 0)),
                  inline: 1,
                },
                {
                  rows: rowSpan,
            ...
            winMan.open(
              {
                ...
                height:
                  320 + parseInt(ed.getLang("table.table_delta_height", 0)),
                inline: 1,
              },
              {
                plugin_url: url,
            ...
            winMan.open(
              {
                url: url + "/row.htm",
                width:
                  400 + parseInt(ed.getLang("table.rowprops_delta_width", 0)),
                height:
                  295 + parseInt(ed.getLang("table.rowprops_delta_height", 0)),
                inline: 1,
              },
              {
                plugin_url: url,
            ...
            winMan.open(
              {
                url: url + "/cell.htm",
                width:
                  400 + parseInt(ed.getLang("table.cellprops_delta_width", 0)),
                height:
                  295 + parseInt(ed.getLang("table.cellprops_delta_height", 0)),
                inline: 1,
              },
              {
                plugin_url: url,
