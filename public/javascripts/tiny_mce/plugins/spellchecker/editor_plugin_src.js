  ...
  tinymce.create("tinymce.plugins.SpellcheckerPlugin", {
    ...
    init: function (ed, url) {
      ...
      ed.addCommand("mceSpellCheck", function () {
        ...
        if (!t.active) {
          ...
          t._sendRPC("checkWords", [t.selectedLang, t._getWords()], function (
            r
          ) {
            if (r.length > 0) {
              t.active = 1;
    ...
    _getWords: function () {
      ...
      if (ed.getParam("spellchecker_word_pattern")) {
        ...
        rawWords = tx.match(
          "(" + ed.getParam("spellchecker_word_pattern") + ")",
          "gi"
        );
      } else {
    ...
    _removeWords: function (w) {
      ...
      each(dom.select("span").reverse(), function (n) {
        if (
          n &&
          (dom.hasClass(n, "mceItemHiddenSpellWord") ||
      ...
      each(nl, function (n) {
        ...
        if (n.nodeType == 3) {
          ...
          if (r1.test(v) || r2.test(v) || r3.test(v) || r4.test(v)) {
            ...
            v = v.replace(
              r5,
              '<span class="mceItemHiddenSpellWord">$1</span>$2'
            );
            v = v.replace(
              r3,
              '<span class="mceItemHiddenSpellWord">$1</span>$2'
    ...
    _showMenu: function (ed, e) {
      ...
      if (dom.hasClass(wordSpan, "mceItemHiddenSpellWord")) {
        ...
        t._sendRPC(
          "getSuggestions",
          [t.selectedLang, dom.decode(wordSpan.innerHTML)],
          function (r) {
            var ignoreRpc;
            ...
            m.add({
              ...
              onclick: function () {
                ...
                if (ignoreRpc) {
                  ed.setProgressState(1);
                  t._sendRPC("ignoreWord", [t.selectedLang, word], function (
                    r
                  ) {
                    ed.setProgressState(0);
                  });
            ...
            m.add({
              ...
              onclick: function () {
                ...
                if (ignoreRpc) {
                  ed.setProgressState(1);
                  t._sendRPC("ignoreWords", [t.selectedLang, word], function (
                    r
                  ) {
                    ed.setProgressState(0);
                  });
    ...
    _sendRPC: function (m, p, cb) {
      ...
      JSONRequest.sendRPC({
        ...
        error: function (e, x) {
          ...
          t.editor.windowManager.alert(
            e.errstr || "Error response: " + x.responseText
          );
        },
      });
    },
