          ...
          each(dom.select("IMG", o.node), function (n) {
            ...
            if (isMediaElm(n)) {
              ...
              dom.setAttrib(
                n,
                "width",
                dom.getAttrib(n, "width", p.width || 100)
              );
              dom.setAttrib(
                n,
                "height",
                dom.getAttrib(n, "height", p.height || 100)
              );
            }
          });
        }
          ...
          each(dom.select("IMG", o.node), function (n) {
            ...
            switch (n.className) {
              ...
              case "mceItemWindowsMedia":
                ci = ed.getParam("media_wmp6_compatible")
