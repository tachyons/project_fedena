...
Date.prototype.getWeekOfYear = function (firstDayOfWeek) {
  ...
  var daynum =
    (Date.UTC(y, m, d, 0, 0, 0) - Date.UTC(y, 0, 1, 0, 0, 0)) / 86400000 + 1;
...
(function () {
  ...
  Date.Translator = {
    ...
    month: function (s) {
      return function () {
        this.month =
          s.length == 3 ? Date.getMonthNumberFromName(s) : Number(s) - 1;
      };
    },
    year: function (s) {
      return function () {
    ...
    finishExact: function (x) {
      ...
      this.hour =
        this.meridian == "p" && this.hour < 13 ? this.hour + 12 : this.hour;
    ...
    finish: function (x) {
      ...
      if (expression) {
        ...
        if (this.meridian && this.hour) {
          this.hour =
            this.hour < 13 && this.meridian == "p" ? this.hour + 12 : this.hour;
        }
        if (this.weekday && !this.day) {
          this.day = today
            .addDays(Date.getDayNumberFromName(this.weekday) - today.getDay())
            .getDate();
        }
