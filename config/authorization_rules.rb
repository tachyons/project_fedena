authorization do
  ...
  role :view_results do
    ...
    has_permission_on [:exam], to: %i[index
                                      exam_wise_report
                                      list_exam_types
                                      generated_report
                                      graph_for_generated_report
  ...
  role :manage_timetable do
    has_permission_on [:class_timings], to: %i[index edit destroy show new create update]
    has_permission_on [:weekday], to: %i[index week create]
  ...
  role :timetable_view do
    has_permission_on [:timetable], to: %i[index
                                           update_timetable
                                           view
                                           teachers_timetable
                                           update_teacher_tt
  ...
  role :student_attendance_view do
    has_permission_on [:attendance], to: %i[index report student_report]
    has_permission_on [:attendance_reports], to: %i[index subject mode show year report filter student_details report_pdf filter_report_pdf]
    has_permission_on [:student_attendance], to: %i[index student]
  end

  role :student_attendance_register do
    has_permission_on [:attendance], to: %i[index register register_attendance]
    has_permission_on [:attendances], to: %i[index list_subject show new create edit update destroy subject_wise_register daily_register]
  ...
  role :add_new_batch do
    ...
    has_permission_on [:courses], to: %i[index manage_course manage_batches find_course new create destroy edit update show update_batch grouped_batches create_batch_group edit_batch_group update_batch_group delete_batch_group assign_subject_amount edit_subject_amount destroy_subject_amount]
    has_permission_on [:batches], to: %i[index new create destroy edit update show init_data assign_tutor update_employees assign_employee batches_ajax]
    has_permission_on [:subjects], to: %i[index new create destroy edit update show]
    has_permission_on [:elective_groups], to: %i[index new create destroy edit update show]
    has_permission_on [:student], to: %i[electives assign_students unassign_students assign_all_students unassign_all_students profile guardians show_previous_details]
  ...
  role :subject_master do
    has_permission_on [:configuration], to: [:index]
    has_permission_on [:student], to: %i[electives assign_students unassign_students assign_all_students unassign_all_students]
    has_permission_on [:subjects],        to: %i[index new create destroy edit update show]
    has_permission_on [:elective_groups], to: %i[index new create destroy edit update show]
  end
  ...
  role :sms_management do
    has_permission_on [:configuration], to: [:index]
    has_permission_on [:sms], to: %i[index settings students batches employees departments all update_general_sms_settings list_students sms_all list_employees show_sms_messages show_sms_logs]
  end
  role :event_management do
    has_permission_on [:event], to: %i[index show confirm_event cancel_event select_course event_group course_event remove_batch select_employee_department department_event remove_department edit_event]
    has_permission_on [:calendar], to: [:event_delete]
  end

  role :general_settings do
    has_permission_on [:configuration], to: %i[index settings permissions]
    has_permission_on [:student], to: %i[add_additional_details change_field_priority delete_additional_details edit_additional_details categories category_delete category_edit category_update]
  end
  ...
  role :employee_timetable_access do
    has_permission_on [:timetable], to: %i[employee_timetable update_employee_tt timetable_pdf]
  ...
  role :admin do
    ...
    has_permission_on [:sms], to: %i[index settings update_general_sms_settings students list_students batches sms_all employees list_employees departments all show_sms_messages show_sms_logs]
    has_permission_on [:sms_settings], to: %i[index update_general_sms_settings]
    has_permission_on [:class_timings], to: %i[index edit destroy show new create update]
    has_permission_on [:attendance_reports], to: %i[index subject mode show year report filter student_details report_pdf filter_report_pdf]
    has_permission_on [:student_attendance], to: %i[index student month]
    has_permission_on [:configuration], to: %i[index settings permissions add_weekly_holidays delete]
    has_permission_on [:subjects], to: %i[index new create destroy edit update show]
    has_permission_on [:elective_groups], to: %i[index new create destroy edit update show]
    ...
    has_permission_on [:holiday], to: %i[index edit delete]
    has_permission_on [:news],
                      to: %i[
                        index
                        add
  ...
  role :student do
    ...
    has_permission_on [:subject], to: %i[index list_subjects]
    has_permission_on [:timetable], to: %i[student_view update_student_tt]
    has_permission_on [:attendance], to: [:student_report]
    has_permission_on [:student_attendance], to: %i[index student month]
    has_permission_on [:finance], to: [:student_fees_structure]
    has_permission_on [:cce_reports], to: %i[student_transcript student_report_pdf]
  end
  ...
  role :parent do
    ...
    has_permission_on [:subject], to: %i[index list_subjects]
    has_permission_on [:timetable], to: %i[student_view update_timetable_view]
    has_permission_on [:attendance], to: [:student_report]
    has_permission_on [:student_attendance], to: %i[index student month]
    has_permission_on [:finance], to: [:student_fees_structure]
  end
  ...
  role :employee do
    ...
    has_permission_on [:timetable], to: %i[employee_timetable update_employee_tt]
    has_permission_on [:news],
                      to: %i[
                        index
                        all
    ...
    has_permission_on [:student_attendance], to: [:index]
    has_permission_on [:attendances], to: %i[index list_subject show subject_wise_register daily_register new create edit update destroy]
    has_permission_on [:attendance_reports], to: %i[new index subject mode show year report filter student_details report_pdf filter_report_pdf student]
    has_permission_on [:cce_reports], to: %i[index student_wise_report student_wise_report_pdf student_report student_report_pdf student_transcript]
  end

  role :subject_attendance do
    has_permission_on [:attendances], to: %i[index list_subject show new create edit update destroy subject_wise_register]
    has_permission_on [:attendance_reports], to: %i[index subject mode show year report filter student_details report_pdf filter_report_pdf]
  end
