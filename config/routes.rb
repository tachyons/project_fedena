ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :ranking_levels, collection: { create_ranking_level: %i[get post], edit_ranking_level: %i[get post], update_ranking_level: %i[get post], delete_ranking_level: %i[get post], ranking_level_cancel: %i[get post], change_priority: %i[get post] }
  ...
  map.resources :fa_groups, collection: { assign_fa_groups: %i[get post], new_fa_criteria: %i[get post], create_fa_criteria: %i[get post], edit_fa_criteria: %i[get post], update_fa_criteria: %i[get post], destroy_fa_criteria: [:post], reorder: %i[get post] }
  #  do |fa|
  ...
  map.resources :observation_groups, member: { new_observation: %i[get post], create_observation: %i[get post], edit_observation: %i[get post], update_observation: %i[get post], destroy_observation: [:post], reorder: %i[get post] }, collection: { assign_courses: %i[get post], set_observation_group: %i[get post] }
  map.resources :cce_weightages, member: { assign_courses: %i[get post] }, collection: { assign_weightages: %i[get post] }
  map.resources :cce_grade_sets, member: { new_grade: %i[get post], edit_grade: %i[get post], update_grade: %i[get post], destroy_grade: [:post] }
  ...
  map.resources :courses, has_many: :batches, collection: { grouped_batches: %i[get post], create_batch_group: %i[get post], edit_batch_group: %i[get post], update_batch_group: %i[get post], delete_batch_group: %i[get post], assign_subject_amount: %i[get post], edit_subject_amount: %i[get post], destroy_subject_amount: %i[get post] }
