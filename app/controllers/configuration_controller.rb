...
class ConfigurationController < ApplicationController
  ...
  FILE_EXTENSIONS = ['.jpg', '.jpeg', '.png'].freeze # ,".gif",".png"]
  FILE_MAXIMUM_SIZE_FOR_FILE = 1_048_576

  def settings
    @config = Configuration.get_multiple_configs_as_hash %w[InstitutionName InstitutionAddress InstitutionPhoneNo
    ...
    if request.post?
      ...
      flash[:notice] = t('flash_msg8').to_s
