...
class EventController < ApplicationController
  ...
  def course_event
    ...
    batch_id_list&.each do |c|
      ...
      next unless batch_event_exists.nil?
  ...
  def department_event
    ...
    department_id_list&.each do |c|
      ...
      next unless department_event_exists.nil?
      ...
      unless batch_event.empty?
        batch_event.each do |b|
          ...
          @batch_students.each do |s|
            ...
            next unless sms_setting.application_sms_active && sms_setting.event_news_sms_active
            ...
            next unless sms_setting.parent_sms_active
  ...
  def cancel_event
    ...
    batch_event&.each(&:destroy)
    dept_event&.each(&:destroy)
  ...
  def edit_event
    ...
    redirect_to action: 'show', id: @event.id, cmd: 'edit' if request.post? && @event.update_attributes(params[:event])
  end
end
