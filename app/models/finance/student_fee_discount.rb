...
class StudentFeeDiscount < FeeDiscount
  ...
  validates_presence_of :receiver_id, message: t('student_admission_no_cant_be_blank').to_s

  validates_uniqueness_of :name, scope: %i[finance_fee_category_id type receiver_id]
