...
class Attendance < ActiveRecord::Base
  ...
  named_scope :by_month, ->(d) { { conditions: { month_date: d.beginning_of_month..d.end_of_month } } }
  named_scope :by_month_and_batch, ->(d, b) { { conditions: { month_date: d.beginning_of_month..d.end_of_month, batch_id: b } } }
  ...
  def after_validate
    if month_date.nil?
      ...
      if student.present? && (month_date < student.admission_date)
